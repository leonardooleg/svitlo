                                ...
                                <div class="card mb-0 border-0 shadow-none mb-0">
                                    <div class="card-body p-sm-5 m-lg-4">
                                        <div class="text-center mt-2">
                                            <h5 class="fs-3xl">Забули пароль?</h5>
                                            <p class="text-muted mb-4">Відновіть свій забутий пароль</p>
                                            <div class="pb-4">
                                                <img src="https://img.themesbrand.com/judia/auth/email.png" alt="" class="avatar-md">
                                            </div>
                                        </div>
                                        ...
                                        <div class="p-2">
                                            <form method="POST" action="{{ route('password.email') }}">
                                                ...
                                                <div class="text-center mt-4">
                                                    <button class="btn btn-primary w-100" type="submit">Відправити посилання на скидання</button>
                                                </div>
                                            </form><!-- end form -->
                                        </div>
                                        <div class="mt-4 text-center">
                                            <p class="mb-0">Зачекайте, я пам'ятаю свій пароль... <a href="/login" class="fw-semibold text-primary text-decoration-underline"> Натиснути сюди </a> </p>
                                        </div>
                                    </div><!-- end card body -->
                                </div><!-- end card -->
                            </div>
