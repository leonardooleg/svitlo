                            ...
                            <div class="col-xxl-6 mx-auto">
                                <div class="card mb-0 border-0 shadow-none mb-0">
                                    <div class="card-body p-sm-5 m-lg-4">
                                        <div class="text-center">
                                            <h5 class="fs-3xl">Створити новий пароль</h5>
                                            <p class="text-muted mb-5">Ваш новий пароль має відрізнятися від попереднього.</p>
                                        </div>

                                        <div class="p-2">
                                            <form id="auth-form" method="POST" action="{{ route('password.store') }}">
                                                    @csrf
                                                    ...
                                                    <!-- Email Address -->
                                                    <div>
                                                        <input id="email" class="block mt-1 w-full d-none" type="email" name="email" value="{{ $request->email}}" required autofocus autocomplete="username" />
                                                    </div>

                                                    <div class="mb-3">
                                                    <label class="form-label" for="password-input">Пароль</label>
                                                    <div class="position-relative auth-pass-inputgroup">
                                                        <input type="password" name="password" autocomplete="new-password" class="form-control bg-light border-light pe-5 password-input" onpaste="return false" placeholder="Введіть пароль" id="password-input" aria-describedby="passwordInput" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" required>
                                                        <button class="btn btn-link position-absolute end-0 top-0 text-decoration-none text-muted password-addon" type="button" id="password-addon"><i class="ri-eye-fill align-middle"></i></button>
                                                    </div>
                                                    <div id="passwordInput" class="form-text">Ваш пароль має містити 8-20 символів.</div>
                                                </div>

                                                <div class="mb-3">
                                                    <label class="form-label" for="confirm-password-input">Підтвердьте пароль</label>
                                                    <div class="position-relative auth-pass-inputgroup mb-3">
                                                        <input type="password" name="password_confirmation" autocomplete="new-password" class="form-control bg-light border-light pe-5 password-input"  onpaste="return false" placeholder="Повторіть пароль" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" id="confirm-password-input" required>
                                                ...
                                                <div id="password-contain" class="p-3 bg-light mb-2 rounded">
                                                    <h5 class="fs-sm">Пароль має містити:</h5>
                                                    <p id="pass-length" class="invalid fs-xs mb-2">Мінімум <b>8 символів</b></p>
                                                    <p id="pass-lower" class="invalid fs-xs mb-2">У <b>малому регістрі</b> літери (a-z)</p>
                                                    <p id="pass-upper" class="invalid fs-xs mb-2">Принаймні <b>велика</b> літера (A-Z)</p>
                                                    <p id="pass-number" class="invalid fs-xs mb-0">Найменше <b>число</b> (0-9)</p>
                                                </div>

                                                <div class="form-check form-check-primary">
                                                    <input class="form-check-input" type="checkbox" value="" id="auth-remember-check">
                                                    <label class="form-check-label" for="auth-remember-check">Пам'ятай мене</label>
                                                </div>
                                        ...
                                        <div class="mt-4 text-center">
                                            <p class="mb-0">Зачекайте, я пам'ятаю свій пароль... <a href="auth-signin" class="fw-semibold text-primary text-decoration-underline"> Натисніть тут </a> </p>
                                        </div>
                                    </div><!-- end card body -->
                                </div><!-- end card -->
                            </div>
