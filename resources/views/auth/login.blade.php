                ...
                <div class="col-lg-10">
                    <div class="card mb-0 p-2">
                        <div class="row g-0">
                            <div class="col-xxl-5">
                                <div
                                    class="card auth-card h-100 border-0 shadow-none d-none d-sm-block overflow-hidden mb-0">
                                ...
                                <div class="card mb-0 border-0 shadow-none mb-0">
                                    <div class="card-body p-sm-5">
                                        <div class="text-center mt-5">
                                            <h5 class="fs-3xl">Форма входу</h5>
                                            <p class="text-muted">Введіть дані для входу на сайт.</p>
                                        </div>
                                        <div class="p-2 mt-5">
                                            <form method="POST" action="{{ route('login') }}">
                                                ...
                                                <div class="mb-3">
                                                    <div class="float-end">
                                                        <a href="{{ route('password.request') }}" class="text-muted">Забули пароль?</a>
                                                    </div>
                                                ...
                                                <div class="form-check">
                                                    ...
                                                    <label class="form-check-label" for="auth-remember-check">Запам'ятати мене</label>
                                                </div>
                                            ...
                                            <div class="text-center mt-5">
                                                <p class="mb-0">Ще не маєте акаунту? <a
                                                        href="{{ route('register') }}"
